...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit('`**ANCIENT** Berhasil Di Update!`')
    await asyncio.sleep(1)
    await event.edit('`ANCIENT Di Restart....`')
    await asyncio.sleep(1)
    await event.edit('`Silahkan Tunggu BLOKKK!`')
    await asyncio.sleep(10)
    await event.delete()
...
async def upstream(event):
    ...
    if conf is None and force_update is False:
        changelog_str = f'**UPDATE Terbaru Untuk ANCIENT [{ac_br}]:\n\nPERUBAHAN:**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('`Proses Update ANCIENT-MIX, ....🛠️`')
        await event.edit('`Proses Update ANCIENT-MIX, loading....🛠️`')
        await event.edit('`Proses Update ANCIENT-MIX, updating....🛠️`')
        await event.edit('`Proses Update ANCIENT-MIX silahkan tunggu ganteng....🛠️`')
    if conf == "now":
